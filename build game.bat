...
CD ..\..\..\..\src
..\bin\x86\win32\7za.exe a -tzip -mx9 ..\%RELEASEDIR%\game.love common engine\client engine\shared engine\init.lua fonts game\client game\shared game\init.lua images public regions schemes shaders sounds class.lua conf.lua main.lua
CD ..\%RELEASEDIR%
